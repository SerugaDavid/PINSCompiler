...
Defs [1:1-28:17]
  FunDef [1:1-10:2]: main
    ...
    # framed as: FRAME [main]: level=1,locals_size=8,arguments_size=2,parameters_size=4,size=16
    Parameter [1:10-1:25]: args
      # typed as: ARR(10,int)
      # accessed as: Local: size[4],offset[0],sl[1]
      Array [1:15-1:25]
        # typed as: ARR(10,int)
        [10]
  ...
  FunDef [12:1-24:2]: fib
    # typed as: (int) -> int
    # framed as: FRAME [fib]: level=1,locals_size=4,arguments_size=2,parameters_size=4,size=12
...
Defs [1:1-15:17]
  FunDef [1:1-11:2]: main
    # typed as: (ARR(10,int)) -> int
    # framed as: FRAME [main]: level=1,locals_size=8,arguments_size=0,parameters_size=4,size=16
    Parameter [1:10-1:25]: args
      # typed as: ARR(10,int)
      # accessed as: Local: size[4],offset[0],sl[1]
      Array [1:15-1:25]
...
Defs [1:1-44:17]
  FunDef [1:1-14:2]: main
    # typed as: (ARR(10,int)) -> int
    # framed as: FRAME [main]: level=1,locals_size=12,arguments_size=2,parameters_size=4,size=20
    Parameter [1:10-1:25]: args
      # typed as: ARR(10,int)
      # accessed as: Local: size[4],offset[0],sl[1]
      Array [1:15-1:25]
  ...
  FunDef [16:1-27:2]: najvecji
    # typed as: (ARR(10,int)) -> int
    # framed as: FRAME [najvecji]: level=1,locals_size=8,arguments_size=0,parameters_size=4,size=16
  ...
  FunDef [29:1-40:2]: najmanjsi
    # typed as: (ARR(10,int)) -> int
    # framed as: FRAME [najmanjsi]: level=1,locals_size=8,arguments_size=0,parameters_size=4,size=16
...
Defs [1:1-59:17]
  FunDef [1:1-55:2]: main
    ...
    # framed as: FRAME [main]: level=1,locals_size=52,arguments_size=3,parameters_size=4,size=60
    ...
    Where [1:34-55:2]
      ...
      Defs [24:5-54:6]
        ...
        FunDef [30:5-41:6]: najvecji
          # typed as: (ARR(10,int)) -> int
          # framed as: FRAME [L[0]]: level=2,locals_size=8,arguments_size=0,parameters_size=4,size=16
          Parameter [30:18-30:34]: array
            # typed as: ARR(10,int)
            # accessed as: Local: size[4],offset[0],sl[2]
            Array [30:24-30:34]
              # typed as: ARR(10,int)
              [10]
        ...
        FunDef [43:5-54:6]: index
          ...
          # framed as: FRAME [L[1]]: level=2,locals_size=8,arguments_size=0,parameters_size=8,size=16
...
Defs [1:1-52:17]
  ...
  FunDef [21:1-26:2]: deljiva
    ...
    # framed as: FRAME [deljiva]: level=1,locals_size=4,arguments_size=0,parameters_size=8,size=12
  ...
  FunDef [28:1-28:42]: deljivaZ2
    # typed as: (int) -> log
    # framed as: FRAME [deljivaZ2]: level=1,locals_size=0,arguments_size=3,parameters_size=4,size=8
  ...
  FunDef [29:1-29:42]: deljivaS3
    # typed as: (int) -> log
    # framed as: FRAME [deljivaS3]: level=1,locals_size=0,arguments_size=3,parameters_size=4,size=8
  ...
  FunDef [31:1-48:2]: preveriArr
    ...
    # framed as: FRAME [preveriArr]: level=1,locals_size=12,arguments_size=2,parameters_size=4,size=20
...
Defs [5:1-48:2]
  ...
  FunDef [9:1-48:2]: main
    ...
    # framed as: FRAME [main]: level=1,locals_size=12,arguments_size=4,parameters_size=4,size=20
    ...
    Where [9:33-48:2]
      ...
      Defs [15:5-47:6]
        ...
        FunDef [20:5-47:6]: getNumberOfTasks
          ...
          # framed as: FRAME [L[0]]: level=2,locals_size=212,arguments_size=0,parameters_size=12,size=220
          ...
          Where [20:63-47:6]
            ...
            Defs [33:9-46:10]
              ...
              FunDef [39:9-46:10]: getTasks
                ...
                # framed as: FRAME [L[1]]: level=3,locals_size=200,arguments_size=0,parameters_size=8,size=208
                Parameter [39:22-39:27]: n
                  # typed as: int
                  # accessed as: Local: size[4],offset[0],sl[3]
